...
engine = create_engine('postgresql://postgres:!Rjkbx270220R!@localhost/postgres', echo=True)
...
class DBWork:
    ...
    def __init__(self):
        self.engine = create_engine('postgresql://postgres:!Rjkbx270220R!@localhost/postgres', echo=True)
